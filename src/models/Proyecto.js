...
class Proyecto {
  ...
  _validar() {
    ...
    if (this.organizacionId === undefined || this.organizacionId === null || isNaN(Number(this.organizacionId))) {
    ...
    if (this.montoObjetivo !== undefined && this.montoObjetivo !== null) {
      if (isNaN(Number(this.montoObjetivo)) || Number(this.montoObjetivo) <= 0) {
